        ...
        <div class="row row-30 justify-content-center box-ordered">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">Inglaterra</a></h6>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">España</a></h6>
                    </div>
                </article>
            </div>
        </div>
        <div class="row row-30 justify-content-center box-ordered">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                ...
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">USA
                </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                <!-- Team Modern-->
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">Alemania</a></h6>
                    </div>
                </article>
            </div>
        </div>
