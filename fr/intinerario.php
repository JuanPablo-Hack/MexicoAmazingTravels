...
<body>
    ...
    <div class="page">
        ...
        echo '<a class="button button-lg button-danger button-ujarak" style="background-color:red; color:white;" href="paquetes.php?destino=chiapas">Retourner</a> <br><br><br>';
