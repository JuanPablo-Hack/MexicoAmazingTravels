            ...
            <div class="row row-14 gutters-14">
                ...
                <div class="col-md-4">
                    <select name="datos[]" class="form-input" data-constraints="@Selected" id="numero_niños" onchange="calcularPersonas()">
                        ...
                        <option value="0">Sans Enfants</option>
                ...
                <div class="col-md-4">
                    <div class="form-wrap">
                        <input class="form-input-total" type="text" readonly placeholder="Nombre total de personnes" id="totalPersonas" style="background-color: #E8B11F; color: white;" />
                    </div>
                </div>
