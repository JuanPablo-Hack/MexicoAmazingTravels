<section class="section section-sm">
    <div class="container">
        <h3 class="title-block find-car oh"><span class="d-inline-block wow slideInUp" style="visibility: visible; animation-name: slideInUp;">Connaître les expériences de nos clients</span></h3>
        <div class="row row-30 justify-content-center box-ordered">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">Angleterre</a></h6>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">Italie</a></h6>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">Espagne</a></h6>
                    </div>
                </article>
            </div>
        </div>
        <div class="row row-30 justify-content-center box-ordered">
            ...
            <div class="col-sm-6 col-md-5 col-lg-3">
                ...
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">L'Autriche</a></h6>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                <!-- Team Modern-->
                <article class="team-modern">
                    <div class="team-modern-header"><a class="team-modern-figure" href="#"><img class="img-circles" src="../assets/images/bandera_usa.png" alt="" width="118" height="118"></a>
                        <svg x="0px" y="0px" width="270px" height="70px" viewBox="0 0 270 70" enable-background="new 0 0 270 70" xml:space="preserve">
                            <g>
                                <path fill="#161616" d="M202.085,0C193.477,28.912,166.708,50,135,50S76.523,28.912,67.915,0H0v70h270V0H202.085z"></path>
                            </g>
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">États Unis</a></h6>
                    </div>
                </article>
            </div>
            <div class="col-sm-6 col-md-5 col-lg-3">
                ...
                <article class="team-modern">
                    ...
                    <div class="team-modern-caption">
                        <h6 class="team-modern-name"><a href="#">Allemagne</a></h6>
                    </div>
                </article>
            </div>
        </div>
