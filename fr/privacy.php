                ...
                <ul class="list-xl box-typography">
                    <li>
                        ...
                        <p>
                            ...
                            données. N'oubliez pas que vous avez toujours le droit de décider. <br> <br>
                        </p>
                        <h4>Notre engagement</h4>
                        <p>
                            Cette politique de confidentialité vous indique comment nous utilisons les informations personnelles collectées sur ce site.
                            Veuillez lire cette politique de confidentialité avant d'utiliser le site ou de soumettre des informations personnelles. Au
                            En utilisant le site, vous acceptez la politique de confidentialité. <br> <br>
                            Ces politiques peuvent être modifiées, mais tout changement sera affiché et les changements ne seront
                            s'appliquent aux activités et informations futures, et non rétroactivement. Nous vous recommandons de revoir
                            ...
                            Nous nous engageons à mettre en œuvre et à maintenir les technologies numériques, techniques, physiques et
                            mesures administratives raisonnables et appropriées pour protéger vos données personnelles. Cependant, aucun
                            entreprise, peut garantir la sécurité absolue des communications Internet. <br> <br> <br>
                        </p>
                        <h4> Données personnelles que nous collectons</h4>
                        <p>
                        ...
                        <p>
                            Les informations ne sont pas fournies à d'autres sociétés à des fins de marketing, mais nous pouvons partager
                            informations avec des agences gouvernementales ou d'autres sociétés qui nous aident à prévenir ou
                            enquête sur la fraude. Nous pouvons le faire dans les cas suivants : <br> <br>
                            <fort>
                                A) Lorsque la loi l'autorise ou l'exige. <br>
                                B) Protéger ou prévenir les fraudes réelles ou potentielles ou les transactions non autorisées.
                                autorisé. <br>
                        ...
                        <p>
                            ...
                            Identification des opportunités clients. Identifier et évaluer de nouveaux utilisateurs
                            ...
                            la sécurité de toute personne ou des violations de nos conditions d'utilisation ou de cet avis. Pouvons
                            utiliser des technologies d'apprentissage automatique ou en profondeur à ces fins (par exemple, pour
                            prévention ou détection de la fraude). <br><br>
                        </p>
                        <h4> Données personnelles que nous ne collectons PAS</h4>
                        <p>
                            Nous ne collectons pas de données personnelles sensibles telles que les numéros de sécurité sociale, les numéros
                            permis de conduire, cartes d'identité nationales, numéros de passeport, votre emplacement
                            origines géographiques, raciales ou ethniques précises, convictions religieuses ou philosophiques, affiliations
                            syndicats, le contenu de votre courrier ou vos données génétiques. <br> <br>
                            Si nous avons une raison quelconque de collecter des données personnelles sensibles, nous le ferons conformément
                            avec vos droits et choix, comme décrit dans la section Vos droits, et dans un but
                            entreprise clairement définie <br> <br>
                            Nous ne collectons pas les identifiants de compte, les informations financières, les numéros de carte de crédit ou
                            carte de débit en combinaison avec vos codes de sécurité ou mots de passe. Si nous avions une raison de
                            collecter des données personnelles sensibles, nous le ferions conformément à vos droits et choix, comme
                            tel que décrit dans la section "vos droits", et dans un but commercial clairement défini. <br><br>
                        </p>
                        <h4>Conservation des données personnelles</h4>
                        <p>
                            Nous conserverons vos données personnelles aux fins énoncées dans nos mentions pendant 7 ans
                            à compter de la dernière date de communication avec vous ou plus si nécessaire à des fins
                            fiscal ou comptable, pour nous assurer que nous pouvons nous défendre ou faire une réclamation, résoudre
                            litiges, faire valoir nos droits contractuels ou lorsque nous avons un besoin légitime,
                            bien que nous ne le fassions généralement pas. <br><br>
                            Lorsque les données personnelles ne sont plus nécessaires, nous les anonymisons ou les supprimons en toute sécurité. <br><br>
                        </p>
                        <h4>Données personnelles des enfants</h4>
                        <p>
                            Notre site n'est pas destiné aux enfants de moins de 15 ans et nous ne collectons pas sciemment de données
                            mineurs personnels Nous encourageons les parents et les tuteurs à observer, participer, surveiller et guider
                            votre activité en ligne. <br></br>
                            Si vous pensez que votre enfant a fourni ce type d'informations sur notre site, nous vous recommandons de
                            contactez-nous immédiatement pour supprimer ces informations de nos dossiers. <br></br>
                            Si vous avez moins de 15 ans, nous vous déconseillons d'utiliser le Site ou les promotions ou de partager
                            données personnelles avec nous. <br><br>
                        </p>
                        <h4> Vos droits</h4>
                        <p>
                            ...
                            <b><u>Objection</u></b>. Vous pouvez vous opposer par écrit à tout traitement de vos données personnelles,
                            ...
                            <b><u>Portabilité</u></b>. Vous pouvez nous demander de vous fournir vos données personnelles dans un format
                            ...
                            <b><u>Rectification</u></b>. Vous pouvez nous demander de mettre à jour ou de corriger les informations que vous pensez
                            inexactes ou que vous pensez incomplètes ; Nous pouvons vérifier l'exactitude des données avant
                            les rectifier. <br><br>
                            <b><u>Contrainte</u></b>. Vous pouvez nous demander de restreindre (c'est-à-dire de conserver, mais pas d'utiliser)
                            vos données personnelles sauf lorsqu'il s'agit de l'application du Point de distribution du
                            Information. <br><br>
                            <b><u>Retrait du consentement</u></b>. Vous pouvez retirer votre consentement lorsque le traitement est
