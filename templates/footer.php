<footer class="site-footer wow fadeInUp">
            ...
            <div class="row">
                ...
                <div class="col-md-3 col-sm-6">
                    <div class="widget widget-customer-info">
                        ...
                        <img src="./assets/dummy/footer-customer-service.jpg" alt="" class="pull-left">
                        <div class="cs-info">
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="branding pull-left">
                <img src="./assets/images/logo-footer.png" alt="Company Name" class="logo">
                <h1 class="site-title"><a href="index.html">Mexico Amazing Travels</a></h1>
                <small class="site-description">Viajes innonvidables al mejor precio</small>
            </div>
    ...
    <div class="colophon">
        <div class="container">
            <p class="copy">Copyright &copy; 2023 Mexico Amazing Travels. Todos los derechos reservados. <br> Diseñado por <a href="jupitersoft.tech" style="text-decoration: none;color: #19bdce;"><strong>JupiterSoftTech</strong></a></p>
        </div>
    </div>
</footer>