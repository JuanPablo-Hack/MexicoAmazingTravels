            ...
            <div class="col-xl-7">
                <ul class="list-xl box-typography">
                    <li>
                        ...
                        <h4>Chi siamo</h4>
                        <p>
                            Messico Incredibile &amp; Indimenticabile è una società dedicata a mostrare al turista internazionale cosa
                            meglio del Messico in un ambiente naturale, amichevole, divertente e sicuro. Sappiamo che puoi
                            essere un visitatore frequente del nostro sito Web per prenotare e viaggiare verso le diverse destinazioni che
                            noi offriamo. Comprendiamo che hai bisogno di tranquillità sapendo come e per cosa sei
                            dati. Non dimenticare che hai sempre il diritto di decidere. <br> <br>
                        </p>
                        <h4>Il nostro impegno</h4>
                        <p>
                            Questa politica sulla privacy ti dice come utilizziamo le informazioni personali raccolte su questo sito.
                            Si prega di leggere questa politica sulla privacy prima di utilizzare il sito o inviare qualsiasi informazione personale. Al
                            Utilizzando il sito, accetti l'informativa sulla privacy. <br> <br>
                            Queste politiche possono essere modificate, ma eventuali modifiche verranno pubblicate e le modifiche lo saranno solo
                            si applicano ad attività e informazioni future, non retroattivamente. Ti consigliamo di rivedere
                            ...
                            Ci impegniamo a implementare e mantenere i dati digitali, tecnici, fisici e
                            misure amministrative ragionevoli e appropriate per proteggere i tuoi dati personali. Tuttavia, nessuno
                            società, può garantire l'assoluta sicurezza delle comunicazioni via Internet. <br> <br> <br>
                        </p>
                        <h4>Dati personali che raccogliamo</h4>
                        <p>
                        ...
                        <p>
                            Le informazioni non vengono fornite ad altre società per scopi di marketing, ma potremmo condividerle
                            informazioni con agenzie governative o altre società che ci aiutano a prevenire o
                            indagine sulle frodi. Possiamo farlo nei seguenti casi: <br> <br>
                            <strong>
                                A) Quando consentito o richiesto dalla legge. <br>
                                B) Per proteggere o prevenire frodi effettive o potenziali o transazioni non autorizzate.
                                autorizzato. <br>
                                C) Per indagare su una frode già avvenuta. <br>
                                D) Su richiesta delle autorità pubbliche, della sicurezza nazionale o delle forze dell'ordine. <br>
                            </strong>
                            <br>
                        </p>
                        ...
                        <p>
                            ...
                            Individuazione opportunità clienti. Identificare e valutare nuovi utenti
                        ...
                        <p>
                            Non raccogliamo dati personali sensibili come codici fiscali, numeri
                            patente di guida, carte d'identità statali, numeri di passaporto, la tua posizione
                            precise origini geografiche, razziali o etniche, convinzioni religiose o filosofiche, affiliazioni
                            sindacati, il contenuto della tua posta o dati genetici. <br> <br>
                            Se abbiamo motivo di raccogliere dati personali sensibili, lo faremo in conformità
                            con i tuoi diritti e le tue scelte, come descritto nella sezione I tuoi diritti, e per uno scopo
                            affari chiaramente definiti <br> <br>
                            Non raccogliamo accessi agli account, informazioni finanziarie, numeri di carte di credito o
                            carta di debito in combinazione con i tuoi codici di sicurezza o password. Se ne avessimo motivo
                            raccogliere dati personali sensibili, lo faremmo in conformità con i tuoi diritti e le tue scelte, come
                            come descritto nella sezione "i tuoi diritti" e per uno scopo commerciale chiaramente definito. <br><br>
                        </p>
                        <h4>Conservazione dei dati personali</h4>
                        <p>
                            Conserveremo i tuoi dati personali per le finalità indicate nelle nostre informative per 7 anni
                            dall'ultima data di comunicazione con Lei o più a lungo se necessario per le finalità
                            fiscali o contabili, per assicurarci di poterci difendere o presentare un reclamo, risolvere
                            controversie, far valere i nostri diritti contrattuali o laddove ne abbiamo una legittima necessità,
                            anche se di solito non lo faremo. <br><br>
                            Quando i dati personali non sono più necessari, li rendiamo anonimi o li eliminiamo in modo sicuro. <br><br>
                        </p>
                        <h4>Dati personali dei bambini</h4>
                        <p>
                            Il nostro Sito non è rivolto a bambini di età inferiore ai 15 anni e non raccogliamo consapevolmente dati
                            minori personali Incoraggiamo genitori e tutori a osservare, partecipare, monitorare e guidare
                            la tua attività online. <br></br>
                            Se ritieni che tuo figlio abbia fornito questo tipo di informazioni sul nostro sito, ti consigliamo di farlo
                            contattaci immediatamente per rimuovere tali informazioni dai nostri archivi. <br></br>
                            Se hai meno di 15 anni, ti consigliamo di non utilizzare il Sito o le promozioni o condividere
                            dati personali con noi. <br><br>
                        </p>
                        ...
                        <p>
                            Per esercitare i tuoi diritti, contattaci utilizzando l'e-mail del Messico
                            Incredibile e fantastico indimenticabile. Non discriminiamo in base al fatto che tu scelga di esercitare le tue opzioni e i tuoi diritti e,
                            in base al tuo esercizio dei diritti, non ti negheremo le Offerte; addebitare tariffe diverse
                            (anche attraverso penali o sconti/benefici); fornire un diverso livello o qualità di
                            Offerte; o suggerire che potresti essere trattato in modo così diverso. <br><br>
                            Elaboreremo qualsiasi richiesta in conformità con le leggi applicabili entro un periodo di tempo
                            ragionevole. Per elaborare correttamente una richiesta, potremmo aver bisogno di verificare la tua identità
                            prima di intraprendere qualsiasi azione relativa alla richiesta. <br><br>
                            Se hai domande, dubbi o commenti sulla nostra politica sulla privacy, puoi farlo
                            comunicare con noi utilizzando le informazioni di contatto di México Amazing &amp; indimenticabile.
                            Ci riserviamo il diritto di apportare modifiche a queste politiche. Eventuali modifiche a queste politiche
                            sarà pubblicato. <br><br>
                        </p>
                    </li>
                    <li>
            </div>
